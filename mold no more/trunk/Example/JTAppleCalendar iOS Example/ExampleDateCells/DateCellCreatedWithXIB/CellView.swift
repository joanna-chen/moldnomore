...
class CellView: JTAppleDayCellView {
    /*@IBInspectable var todayColor = UIColor(red: 254.0/255.0, green: 73.0/255.0, blue: 64.0/255.0, alpha: 0.3)
    @IBInspectable var normalDayColor = UIColor.white*/
    @IBOutlet var selectedView: AnimationView!
    @IBOutlet var dayLabel: UILabel!
    let todayColor = UIColor(colorWithHexValue: 0xbfbfbf)
    let normalDayColor = UIColor.white
...
//        }
    ...
    fileprivate func configueViewIntoBubbleView(_ cellState: CellState, animateDeselection: Bool = false) {
        if cellState.isSelected {
            ...
            //Circle selection
            selectedView.backgroundColor = UIColor(colorWithHexValue: 0xcccccc)
